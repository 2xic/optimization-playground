Instead of pruning after training the full network, the authors argues that there might be a smaller network inside the big network that "carries" most of the results.
